...
//  SwUi
//
//  Created by Viktor Berezhnytskyi on 30.01.2023.
//
...
struct CustomSliderView: View {
    ...
    @State var value: Double = 53
    
    var body: some View {
        VStack {
            CustomSlider(value: $value, in: 0...100, step: 5, minimumValueLabel: Text("0"), maximumValueLabel:  Text("100"), onEditingChanged: { isEdited in
                // Do some
            }, track: {
            ...
            CustomSlider(
                ...
                }, thumbSize: CGSize(width: 40, height: 20))
        }
    }
}
